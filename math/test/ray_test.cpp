...
TEST_CASE("Reflect : Vec3 x Vec3 -> Vec3", "[Ray]")
{
    ...
    {
        Vec3 normal =
            GENERATE(take(10, filter(CanVec3BeUsedToDivide, RandomFiniteVec3(-1.0, 1.0))));
        normal.Normalize();
    ...
    SECTION("Calculation is correct in the axis' planes")
    {
        ...
        {
            CHECK_THAT(Reflect(sign * Vec3{-a_positive, b_positive, Real(0)},
                               sign * Vec3{Real(1), Real(0), Real(0)}),
            ...
            CHECK_THAT(Reflect(sign * Vec3{-a_positive, -b_positive, Real(0)},
                       ...
                       IsComponentWiseApprox<Vec3>(tconst::kRelativeToleranceEqualityCheck,
                                                   sign * Vec3{a_positive, -b_positive, Real(0)}));
            CHECK_THAT(Reflect(sign * Vec3{a_positive, -b_positive, Real(0)},
                               sign * Vec3{Real(0), Real(1), Real(0)}),
                       IsComponentWiseApprox<Vec3>(tconst::kRelativeToleranceEqualityCheck,
                                                   sign * Vec3{a_positive, b_positive, Real(0)}));
            CHECK_THAT(Reflect(sign * Vec3{-a_positive, -b_positive, Real(0)},
                               sign * Vec3{Real(0), Real(1), Real(0)}),
        ...
        {
            CHECK_THAT(Reflect(sign * Vec3{-a_positive, Real(0), b_positive},
                               sign * Vec3{Real(1), Real(0), Real(0)}),
                       IsComponentWiseApprox<Vec3>(tconst::kRelativeToleranceEqualityCheck,
            ...
            CHECK_THAT(Reflect(sign * Vec3{-a_positive, Real(0), -b_positive},
                       ...
                       IsComponentWiseApprox<Vec3>(tconst::kRelativeToleranceEqualityCheck,
                                                   sign * Vec3{a_positive, Real(0), -b_positive}));
            CHECK_THAT(Reflect(sign * Vec3{a_positive, Real(0), -b_positive},
                               sign * Vec3{Real(0), Real(0), Real(1)}),
                       IsComponentWiseApprox<Vec3>(tconst::kRelativeToleranceEqualityCheck,
                                                   sign * Vec3{a_positive, Real(0), b_positive}));
            CHECK_THAT(Reflect(sign * Vec3{-a_positive, Real(0), -b_positive},
                               sign * Vec3{Real(0), Real(0), Real(1)}),
        ...
        {
            CHECK_THAT(Reflect(sign * Vec3{Real(0), -a_positive, b_positive},
                               sign * Vec3{Real(0), Real(1), Real(0)}),
                       IsComponentWiseApprox<Vec3>(tconst::kRelativeToleranceEqualityCheck,

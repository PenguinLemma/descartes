...
inline void DifferentDielectricsScene::LoadWorld()
{
    ...
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{Real(0), Real(-1e5), Real(0)}, Real(1e5),
    ...
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{coordinate_odd_multiples_of_45, Real(0.5), coordinate_odd_multiples_of_45}, Real(0.5),
            std::make_shared<Ice>()
        )
    );
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{radius_big_circle, Real(0.6), Real(0)}, Real(0.6),
            std::make_shared<Water>()
        )
    );
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{coordinate_odd_multiples_of_45, Real(0.7), -coordinate_odd_multiples_of_45}, Real(0.7),
            std::make_shared<OliveOil>()
        )
    );
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{Real(0), Real(0.8), -radius_big_circle}, Real(0.8),
            std::make_shared<WindowGlass>()
        )
    );
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{-coordinate_odd_multiples_of_45, Real(0.9), -coordinate_odd_multiples_of_45}, Real(0.9),
            std::make_shared<FlintGlass>()
        )
    );
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{-radius_big_circle, Real(1), Real(0)}, Real(1),
            std::make_shared<Sapphire>()
        )
    );
    world_.Add(
        std::make_shared<Sphere<Vec3, RealNum> >(
            Vec3{-coordinate_odd_multiples_of_45, Real(1.1), coordinate_odd_multiples_of_45}, Real(1.1),
